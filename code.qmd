...
1.  R Core Team. (2023). *R: A language and environment for statistical computing* (Version 4.0) \[Software\]. R Foundation for Statistical Computing. <https://www.R-project.org/>

2.  Wickham, H. (2016). *ggplot2: Elegant graphics for data analysis*. Springer-Verlag New York. <https://ggplot2.tidyverse.org>

3.  Wickham, H., & Henry, L. (2021). *dplyr: A Grammar of Data Manipulation* (R package version 1.0.7). <https://CRAN.R-project.org/package=dplyr>

4.  Hadley Wickham, Lionel Henry, Thomas Lin Pedersen (2022). *ggrepel*: Automatically Position Non-Overlapping Text Labels with 'ggplot2'. <https://CRAN.R-project.org/package=ggrepel>
